...
export class AboutMeComponent {
  ...
  info = [
    ...
    'Resigned from CTS and joined Apps Team Technologies (a startup in Kochi) as an Angular Developer. Grew my educational content page (@datasciencebrain on Instagram) to over 340,000 followers during this period.',
  ];
}
